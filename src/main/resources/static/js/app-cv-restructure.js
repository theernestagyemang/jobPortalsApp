...
$(function ()
{
    $("#cvRegister").on('click', function () {
        $("#serviceType").val("CV Redesign");
        $("#cvRestrucher-header").html("CV RESTRUCTURING");

        $("#divGrp").addClass("fade");
    })
    ...
    //submit cv-restructure request to //ResumeRequestController
    $('#cv-restructure').on("submit", function (e)
    {
        ...
        var userid = $('#userid').val();  //user logged in from front end
        //console.log(name + " " + email + " " + tel + " " +serviceType);
        ...
        $("#save-sp").addClass("fas fa-circle-notch fa-spin");

        // disabled the submit button
        $("#btnSave2").prop("disabled", true);
        $("#btnSave2").html("Please Wait...");
            ...
            success: function (data) {
                ...
                if (data) {
                    ...
                    swal({
                        ...
                        $("#save-sp").removeClass("fas fa-circle-notch fa-spin");
