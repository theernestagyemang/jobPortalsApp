...
public class CourseTransaction implements Serializable {
    ...
    public CourseTransaction(Integer id, Date entryDate, Double amount, String paymentMethode,
                             String userType, boolean status, String transactionId, Course course, Users users) {
        this.id = id;
