...
public class PackageSubscribeHelper {
    private Integer id;
    private String name;
    ...
    public PackageSubscribeHelper(Integer id, String name, Double price, String comment1, String comment2,
